...
class Task(BaseModel):
    name: str
    description: str  # Changed from 'desc' to 'description'
    timeStamp: str    # Changed from 'timestamp' to 'timeStamp'
    contact: str
...
def update_status(id: Id):
    ...
    try:
        notion_api.set_status_done(id.id)  # Correctly pass the UUID
